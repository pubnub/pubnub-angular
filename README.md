...
```html
<script src="http(s)://cdn.pubnub.com/sdk/pubnub-angular/pubnub-angular-4.0.3.js"></script>
```

- Also available as minified:

```html
<script src="http(s)://cdn.pubnub.com/sdk/pubnub-angular/pubnub-angular-4.0.3.min.js"></script>
```
