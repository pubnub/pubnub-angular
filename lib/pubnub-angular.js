...
(function() {
  ...
  angular.module('pubnub.angular.service', []).factory('PubNub', [
    '$rootScope', '$q', '$timeout', function($rootScope, $q, $timeout) {
      var c, instance, k, _i, _len, _makeDataSyncOperation, _ref, _syncCallback;
      c = {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i];
        if ((instance != null ? instance[k] : void 0) instanceof Function) {
          (function(kk) {
      ...
      c.ngSubscribe = function(args) {
        ...
        if (args.channel_group) {
          if (c['_channel_groups'].indexOf(args.channel_group) < 0) {
