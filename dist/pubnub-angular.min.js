...
e.loaded=!0,e.exports}var c={};return b.m=a,b.c=c,b.p="",b(0)}([function(a,b,c){"use strict";c(1),c(5)},function(a,b,c){"use strict";
var d=c(2),e=c(3);angular.module("pubnub.angular.service",[]).factory("Pubnub",["$rootScope",function(a){if(!angular.isDefined(PUBNUB))throw new Error("PUBNUB is not in global scope. Ensure that pubnub.js file is included before pubnub-angular.js");
...
b}}(),f=c(2),g=c(4);a.exports=function(){function a(b,c,e){d(this,a),this.label=b,this.mockingInstance=new g(b,c,e),this.pubnubInstance=null;
...
}}}(g)}}}]),a}()},function(a,b,c){"use strict";var d=c(2);angular.module("pubnub.angular.service").factory("$pubnubChannel",["$rootScope","Pubnub","$q",function(a,b,c){
...
return angular.isObject(a)&&angular.extend(e.prototype,a),e},e}])}]);
